...
struct VideoProcessingChain {
    ...
    private let actionClassifier = WristRecoveryClassifier.shared
...
extension VideoProcessingChain {
    ...
    private mutating func buildProcessingChain() {
        ...
        frameProcessingChain = upstreamFramePublisher
            ...
            // Detect any human hand poses (or lack of them) in the frame.
...
extension VideoProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        // Use Vision to find human hand poses in the frame.
    ...
    /// Before the methods appends the most recent hand pose multiarray
